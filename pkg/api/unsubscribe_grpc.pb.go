...
type UnsubscribeServiceClient interface {
	Unsubscribe(ctx context.Context, in *internal.Account, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *unsubscribeServiceClient) Unsubscribe(ctx context.Context, in *internal.Account, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/api.UnsubscribeService/Unsubscribe", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UnsubscribeServiceServer interface {
	Unsubscribe(context.Context, *internal.Account) (*empty.Empty, error)
...
func (UnimplementedUnsubscribeServiceServer) Unsubscribe(context.Context, *internal.Account) (*empty.Empty, error) {
...
func _UnsubscribeService_Unsubscribe_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.UnsubscribeService/Unsubscribe",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UnsubscribeServiceServer).Unsubscribe(ctx, req.(*internal.Account))
	}
...
var UnsubscribeService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.UnsubscribeService",
